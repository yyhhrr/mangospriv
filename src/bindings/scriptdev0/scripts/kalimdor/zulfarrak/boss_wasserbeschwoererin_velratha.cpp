/* boss_wasserbeschwoererin_velratha */
...
struct MANGOS_DLL_DECL boss_wasserbeschwoererin_velrathaAI : public ScriptedAI
{
    boss_wasserbeschwoererin_velrathaAI(Creature *c) : ScriptedAI(c) {}
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if (schattenblitz_timer < diff)
        {
            ...
            schattenblitz_timer = random(3000,8000);
        ...
        if (welle_der_heilung_timer < diff)
        {
            ...
            welle_der_heilung_timer = random(10000,15000);
        ...
        if (zauberschutz_von_zum_rah_timer < diff)
        {
            ...
            zauberschutz_von_zum_rah_timer = random(20500,21000);
...
CreatureAI* GetAI_boss_wasserbeschwoererin_velratha(Creature *_Creature)
{
    return new boss_wasserbeschwoererin_velrathaAI (_Creature);
}

void AddSC_boss_wasserbeschwoererin_velratha()
{
    Script *newscript;
    newscript = new Script;
    newscript->Name="boss_wasserbeschwoererin_velratha";
    newscript->GetAI = &GetAI_boss_wasserbeschwoererin_velratha;
