...
bool GossipHello_npc_skorn_whitecloud(Player* pPlayer, Creature* pCreature)
{
    ...
    if (!pPlayer->GetQuestRewardStatus(770))
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Erz\303\244hlt mir eure Geschichte, Skorn.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
...
bool GossipSelect_npc_skorn_whitecloud(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
