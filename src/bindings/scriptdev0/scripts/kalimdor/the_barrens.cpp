...
bool GossipSelect_npc_beaten_corpse(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
...
bool GossipSelect_npc_sputtervalve(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
...
struct MANGOS_DLL_DECL npc_taskmaster_fizzuleAI : public ScriptedAI
{
    ...
    void ReceiveEmote(Player*, uint32 emote)
    {
...
bool AreaTrigger_at_twiggy_flathead(Player* pPlayer, AreaTriggerEntry const*)
{
...
bool GossipSelect_npc_wrenixs_gizmotronic_apparatus(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
    switch(uiAction)
    {
...
bool QuestRewarded_npc_regthar_deathgate(Player*, Creature* pCreature, const Quest* pQuest)
{
