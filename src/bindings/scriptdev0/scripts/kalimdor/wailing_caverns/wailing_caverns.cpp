...
struct MANGOS_DLL_DECL npc_disciple_of_naralexAI : public npc_escortAI
{
    ...
    bool PreEnterEvadeMode()
    {
        ...
        if (m_uiPoint == 15 || m_uiPoint == 32)
        {
            ...
            m_creature->GetMotionMaster()->MovePoint(0xFFFFFF, fPosX, fPosY, fPosZ);
    ...
    {
        // We need this because our mmaps are broken
                        ...
                        switch (m_uiSubeventPhase)
                        {
                            ...
                            case 11:
                                ...
                                if (Creature* pNaralex = m_pInstance->GetSingleCreatureFromStorage(NPC_NARALEX))
                                {
                                    ...
                                    // Set to flying
                                    pNaralex->m_movementInfo.AddMovementFlag(MOVEFLAG_FLYING);
                                    pNaralex->m_movementInfo.RemoveMovementFlag(MOVEFLAG_WALK_MODE);
...
bool GossipSelect_npc_disciple_of_naralex(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
    ScriptedInstance* m_pInstance = (ScriptedInstance*)pCreature->GetInstanceData();
