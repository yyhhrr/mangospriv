...
SDName: Feralas
SD%Complete: 100
SDComment: Quest support: 2845, 3520, 2767. Special vendor Gregan Brewspewer
SDCategory: Feralas
EndScriptData */
...
bool GossipSelect_npc_gregan_brewspewer(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
...
bool EffectDummyCreature_npc_shay_leafrunner(Unit* pCaster, uint32 uiSpellId, SpellEffectIndex uiEffIndex, Creature* pCreatureTarget)
{
