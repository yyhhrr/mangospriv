...
ScriptName: Kanonenmeister Willey
Instanz: Stratholme
Staus in %: 100%
Abgeschlossen?: Ja
...
struct MANGOS_DLL_DECL boss_kanonenmeister_willeyAI : public ScriptedAI
{
    boss_kanonenmeister_willeyAI(Creature *c) : ScriptedAI(c) {}
...
CreatureAI* GetAI_boss_kanonenmeister_willey(Creature *_Creature)
{
    return new boss_kanonenmeister_willeyAI (_Creature);
}

void AddSC_boss_kanonenmeister_willey()
{
    Script *newscript;
    newscript = new Script;
    newscript->Name="kanonenmeister_willey";
    newscript->GetAI = &GetAI_boss_kanonenmeister_willey;
