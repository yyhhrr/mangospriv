...
enum
{
    ...
    TYPE_BLACK_GUARDS           = 8,
	TYPE_THE_UNFORGIVEN			= 9,
	TYPE_AURIUS					= 10,
	TYPE_POSTBOX				= 11,
	TYPE_SLAUGHTER_SQUARE		= 12,
    ...
    GO_PORT_GAUNTLET            = 175374,                   // Port from gauntlet to slaugther - Das erste Tor
    GO_PORT_SLAUGTHER           = 175373,                   // Port at slaugther - Das zweite Tor vor Ramstein
...
/*
static bool sortByDist(MobInfo first, MobInfo second)
{
