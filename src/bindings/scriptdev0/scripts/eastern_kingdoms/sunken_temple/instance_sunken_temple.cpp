        ...
        case TYPE_AVATAR:
            ...
            if (uiData == IN_PROGRESS)
            {
                ...
                if (Creature* pShade = pPlayer->SummonCreature(NPC_SHADE_OF_HAKKAR, aSunkenTempleLocation[1].m_fX, aSunkenTempleLocation[1].m_fY, aSunkenTempleLocation[1].m_fZ, aSunkenTempleLocation[1].m_fO, TEMPSUMMON_MANUAL_DESPAWN, 0))
                {
                    ...
                    pShade->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_DISABLE_MOVE | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE);
            ...
            m_auiEncounter[uiType] = uiData;
            if (uiData == FAIL)
                SetData(TYPE_AVATAR, NOT_STARTED);
...
void instance_sunken_temple::DoSpawnAtalarionIfCan()
{
    ...
    if (Creature* pAtalarion = pPlayer->SummonCreature(5720, aSunkenTempleLocation[0].m_fX, aSunkenTempleLocation[0].m_fY, aSunkenTempleLocation[0].m_fZ, aSunkenTempleLocation[0].m_fO, TEMPSUMMON_DEAD_DESPAWN, 0))
        pAtalarion->GetMotionMaster()->MoveRandomAroundPoint(aSunkenTempleLocation[0].m_fX, aSunkenTempleLocation[0].m_fY, aSunkenTempleLocation[0].m_fZ, 40.f);
