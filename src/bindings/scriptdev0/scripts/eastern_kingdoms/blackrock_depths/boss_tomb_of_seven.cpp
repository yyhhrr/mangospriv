...
#define GOSSIP_ITEM_TEACH_1 "Was ist genau passiert?"
#define GOSSIP_ITEM_TEACH_2 "Weiter..."
#define GOSSIP_ITEM_TRIBUTE "Ich bin bereit!"
...
bool GossipSelect_boss_gloomrel(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
    switch(uiAction)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF+2:
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Verstehe...", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 22);
...
#define GOSSIP_ITEM_CHALLENGE   "Nun ist es zu Ende, Doom'rel. Ich fordere dich heraus!"
...
bool GossipSelect_boss_doomrel(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
    switch(uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF+1:
