...
bool GossipHello_npc_lore_keeper_of_norgannon(Player* pPlayer, Creature* pCreature)
{
    ...
    pPlayer->SEND_GOSSIP_MENU(1079, pCreature->GetObjectGuid());

    return true;
}

bool GossipSelect_npc_lore_keeper_of_norgannon(Player* pPlayer, Creature* pCreature, uint32, uint32 uiAction)
{
    switch(uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF+1:
            ...
            pPlayer->SEND_GOSSIP_MENU(1080, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+2:
            ...
            pPlayer->SEND_GOSSIP_MENU(1081, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+3:
            ...
            pPlayer->SEND_GOSSIP_MENU(1082, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+4:
            ...
            pPlayer->SEND_GOSSIP_MENU(1083, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+5:
            ...
            pPlayer->SEND_GOSSIP_MENU(1084, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+6:
            ...
            pPlayer->SEND_GOSSIP_MENU(1085, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+7:
            ...
            pPlayer->SEND_GOSSIP_MENU(1086, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+8:
            ...
            pPlayer->SEND_GOSSIP_MENU(1087, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+9:
            ...
            pPlayer->SEND_GOSSIP_MENU(1088, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+10:
            ...
            pPlayer->SEND_GOSSIP_MENU(1089, pCreature->GetObjectGuid());
            break;
        case GOSSIP_ACTION_INFO_DEF+11:
            ...
            pPlayer->SEND_GOSSIP_MENU(1090, pCreature->GetObjectGuid());
            break;
