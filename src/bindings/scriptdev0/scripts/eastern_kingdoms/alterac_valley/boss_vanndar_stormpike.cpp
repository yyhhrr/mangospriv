...
struct MANGOS_DLL_DECL boss_vanndar_stormpikeAI : public ScriptedAI
{
    ...
    void Reset()
    {
        m_uiAvatarTimer = 6000;
        m_uiStormboltTimer = 12000;
		m_uiThunderclapTimer = urand(8000, 10000);
        m_uiYellTimer = urand(20000, 30000);
        m_uiEvadeTimer = 5000;
    }
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        if (m_uiAvatarTimer <= uiDiff)
        {
            ...
            m_uiAvatarTimer = urand(15000, 20000);
        }
        else
        ...
        if (m_uiThunderclapTimer <= uiDiff)
        {
            ...
            m_uiThunderclapTimer = urand(5000, 15000);
        }
        else
        ...
        if (m_uiStormboltTimer <= uiDiff)
        {
            ...
            m_uiStormboltTimer = urand(8000, 18000);
        }
        else
