...
bool AreaTrigger_at_example(Player* pPlayer, AreaTriggerEntry const*)
{
...
bool ItemUse_example_item(Player*, Item*, SpellCastTargets const&)
{
    LoadDatabase();
    return true;
}

bool GOUse_example_go_teleporter(Player* pPlayer, GameObject*)
{
