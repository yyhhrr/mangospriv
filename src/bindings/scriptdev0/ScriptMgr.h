...
struct Script
{
	...
	bool (*pEffectDummy				)(Object*, uint32, SpellEffectIndex, Object*);
    bool (*pEffectAuraDummy         )(const Aura*, bool);
	bool (*pEffectAuraApply			)(const Aura*, bool, uint32);
	void (*pFillLoot				)(Loot& loot, Player* owner);

    CreatureAI* (*GetAI             )(Creature*);
    InstanceData* (*GetInstanceData )(Map*);

    void RegisterSelf(bool bReportError = true);
	void RegisterAsAuraScript(bool bReportError = true);
	void RegisterAsLootScript(bool bReportError = true);
	void RegisterAsSpellScript(bool bReportError = true);
};
