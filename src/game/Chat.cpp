...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand accountCommandTable[] =
    {
		...
		{ "pvp",            SEC_PLAYER,         true,  &ChatHandler::HandleSetPvPAccountCommand,       "", NULL },
	...
	{
		{ "list",			SEC_GAMEMASTER,		false, &ChatHandler::HandleChannelListCommand,		   "", NULL },
		{ NULL,				0,					false, nullptr,										   "", NULL },
	};
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "buffme",         SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugBuffMeCommand,              "", NULL },
		{ "dostring",		SEC_CONSOLE,		false, &ChatHandler::HandleLuaDostringCommand,				"", NULL },
		{ "showspellmods",	SEC_GAMEMASTER,		false, &ChatHandler::HandleShowSpellModsCommand,			"", NULL },
        { NULL,             0,                  false, NULL,                                                "", NULL }
    };
	...
	{
        { "levelup",        SEC_GAMEMASTER,     false, &ChatHandler::HandlePetLevelupCommand,          "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
	};
    ...
    static ChatCommand reloadCommandTable[] =
    {
		...
		{ "luaengine",                   SEC_CONSOLE,       true,  &ChatHandler::HandleReloadLuaEngineCommand,               "", NULL },
...
*/
	...
	static ChatCommand harveyAccountTable[] =
	{
		{ "add",			SEC_GAMEMASTER,		false, &ChatHandler::HandleHarveyAccountAdd,		   "", nullptr },
		{ "remove",			SEC_GAMEMASTER,		false, &ChatHandler::HandleHarveyAccountRemove,		   "", nullptr },
		{ nullptr,			0,					false, nullptr,										   "", nullptr },
	};

	static ChatCommand harveyCharTable[] =
	{
		{ "add",			SEC_GAMEMASTER,		false, &ChatHandler::HandleHarveyCharacterAdd,		   "", nullptr },
		{ "remove",			SEC_GAMEMASTER,		false, &ChatHandler::HandleHarveyCharacterRemove,	   "", nullptr },
		{ nullptr,			0,					false, nullptr,										   "", nullptr },
	};

	static ChatCommand harveyIPTable[] =
	{
		{ "add",			SEC_GAMEMASTER,		false, &ChatHandler::HandleHarveyIPAdd,				   "", nullptr },
		{ "remove",			SEC_GAMEMASTER,		false, &ChatHandler::HandleHarveyIPRemove,			   "", nullptr },
		{ nullptr,			0,					false, nullptr,										   "", nullptr },
	};

	static ChatCommand harveyCommandTable[] = 
	{
		{ "account",		SEC_GAMEMASTER,		false, nullptr,										   "", harveyAccountTable },
		{ "char",			SEC_GAMEMASTER,		false, nullptr,										   "", harveyCharTable },
		{ "ip",				SEC_GAMEMASTER,		false, nullptr,										   "", harveyIPTable },
		{ nullptr,			0,					false, nullptr,										   "", nullptr },
	};

	static ChatCommand trackingCommandTable[] = 
	{
		{ "listdestroyed",	SEC_GAMEMASTER,		false, &ChatHandler::HandleLookupDestroyedItemCommand,	"", nullptr },
		{ "listreceived",	SEC_GAMEMASTER,		false, &ChatHandler::HandleLookupReceivedItemCommand,	"", nullptr },
		{ "listbosses",		SEC_GAMEMASTER,		false, &ChatHandler::HandleLookupKilledBossesCommand,	"", nullptr },
		{ nullptr,			0,					false, nullptr,											"", nullptr },
	};

	static ChatCommand premadeCommandTable[] =
	{
		{ "pre",			SEC_CONSOLE,			false, &ChatHandler::HandlePremadePreCommand,			"", NULL },
		{ "mc",				SEC_CONSOLE,			false, &ChatHandler::HandlePremadeEntryCommand,			"", NULL },
		{ "bwl",			SEC_CONSOLE,			false, &ChatHandler::HandlePremadeBWLCommand,			"", NULL },
		{ "aq",				SEC_CONSOLE,			false, &ChatHandler::HandlePremadeAQCommand,			"", NULL },
		{ "naxx",			SEC_CONSOLE,			false, &ChatHandler::HandlePremadeNaxxCommand,			"", NULL },
		{ nullptr,			0,						false, nullptr,											"", nullptr },
	};
    ...
    static ChatCommand commandTable[] =
    {
		...
		{ "pet",			SEC_MODERATOR,		false, NULL,										   "", petCommandTable		},
		...
		{ "harvey",			SEC_GAMEMASTER,		true,  nullptr,										   "", harveyCommandTable   },
		{ "tracking",		SEC_GAMEMASTER,		true,  nullptr,										   "", trackingCommandTable   },
		...
		{ "schnellreise",	SEC_PLAYER,         false, &ChatHandler::HandleInstantFlightCommand,       "", NULL },
		{ "summonall",		SEC_ADMINISTRATOR,	false, &ChatHandler::HandleSummonAllCommand,		   "", NULL },
		{ "summonraid",		SEC_ADMINISTRATOR,	false, &ChatHandler::HandleSummonRaidCommand,		   "", NULL },
		{ "summonandress",  SEC_ADMINISTRATOR,  false, &ChatHandler::HandleSummonAndRessRaidCommand,   "", NULL },
		{ "crash",			SEC_ADMINISTRATOR,  false, &ChatHandler::HandleCrashCommand,			   "", NULL },
		{ "premade",		SEC_CONSOLE,		false, NULL,										   "", premadeCommandTable },
