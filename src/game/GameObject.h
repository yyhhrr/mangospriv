...
class MANGOS_DLL_SPEC GameObject : public WorldObject
{
    public:
		...
		void SetGoState(GOState state, bool save = true);
		...
		void StartDecayTime() { ++m_decayCount; }
		void StopDecayTime() { m_decayCount = 0; }
		uint32 GetDecayCount() const { return m_decayCount; }
