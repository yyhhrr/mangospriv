...
SpellAuraProcResult Unit::HandleHasteAuraProc(Unit *pVictim, uint32 damage, Aura* triggeredByAura, SpellEntry const * /*procstd::shared_ptr<Spell>*/, uint32 /*procFlag*/, uint32 /*procEx*/, uint32 cooldown)
{
        ...
        case SPELLFAMILY_GENERIC:
        {
            switch (dummySpell->Id)
            {
                ...
                case 25988:
                {
                    ...
                    basepoints[0] = triggerAmount*int32(damage + SpellBaseDamageBonusDone(SPELL_SCHOOL_MASK_HOLY))/100;
    ...
    switch (auraSpellInfo->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_WARLOCK:
        {
            ...
            if (auraSpellInfo->SpellIconID == 1137)
            {
                ...
                // Soulfire has 1 tick, Hellfire have 15 tick
                if (procSpell->SpellFamilyFlags & UI64LIT(0x0000000000000040))
                    tick = (procSpell->Reagent[0] == 6265) ? 1 : 15;
...
SpellAuraProcResult Unit::HandleModResistanceAuraProc(Unit* /*pVictim*/, uint32 damage, Aura* triggeredByAura, SpellEntry const* /*procstd::shared_ptr<Spell>*/, uint32 /*procFlag*/, uint32 /*procEx*/, uint32 /*cooldown*/)
{
    SpellEntry const *spellInfo = triggeredByAura->GetSpellProto();
