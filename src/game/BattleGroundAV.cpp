...
void BattleGroundAV::CheckPlayerSize()
{
	//weltklasse
	Map* pMap = GetBgMap();
...
void BattleGroundAV::HandleKillUnit(Creature *creature, Player *killer)
{
    ...
    switch(event1)
    {
        case BG_AV_BOSS_A:
            ...
            PlaySoundToAll(BG_AV_SOUND_HORDE_GOOD);
        ...
        case BG_AV_BOSS_H:
            ...
            PlaySoundToAll(BG_AV_SOUND_ALLIANCE_GOOD);
...
void BattleGroundAV::EventPlayerDestroyedPoint(BG_AV_Nodes node)
{
    ...
    PlaySoundToAll(ownerTeam == ALLIANCE ? BG_AV_SOUND_ALLIANCE_GOOD : BG_AV_SOUND_HORDE_GOOD);
}
...
void BattleGroundAV::EventPlayerAssaultsPoint(Player* player, BG_AV_Nodes node)
{
    ...
    PlaySoundToAll((teamIdx == BG_TEAM_ALLIANCE) ? BG_AV_SOUND_ALLIANCE_CAPTURE : BG_AV_SOUND_HORDE_CAPTURE);
}
