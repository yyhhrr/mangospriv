...
class ScriptMgr
{
    public:
		...
		bool OnEffectDummy(Object* pCaster, uint32 spellId, SpellEffectIndex effIndex, Object* pTarget);
        bool OnAuraDummy(Aura const* pAura, bool apply);
		bool OnAuraApply(Aura const* pAura, bool apply, AuraType type);
		void OnUpdateLoot(Loot& loot, Player* lootOwner, uint32 id);
    ...
    private:
		...
		bool (MANGOS_IMPORT* m_pOnEffectDummy) (Object*, uint32, SpellEffectIndex, Object*);
        bool (MANGOS_IMPORT* m_pOnAuraDummy) (Aura const*, bool);
		bool (MANGOS_IMPORT* m_pOnAuraApply)(Aura const*, bool, AuraType);
		void (MANGOS_IMPORT* m_pFillLoot)(Loot&, Player*, uint32);
};
