...
uint32 GetSpellCastTime(SpellEntry const* spellInfo, const std::shared_ptr<Spell> spell = NULL);
...
{
    return ((spellInfo->AttributesEx & SPELL_ATTR_EX_UNK4) ? false : !(spellInfo->AttributesEx & SPELL_ATTR_EX_NOT_BREAK_STEALTH));
}
