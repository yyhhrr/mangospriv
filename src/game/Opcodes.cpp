...
void Opcodes::BuildOpcodeList()
{
	...
	/*0x1FF*/  StoreOpcode(MSG_LOOKING_FOR_GROUP, "MSG_LOOKING_FOR_GROUP", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide);
	/*0x200*/  StoreOpcode(CMSG_SET_LOOKING_FOR_GROUP, "CMSG_SET_LOOKING_FOR_GROUP", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide);
    ...
    /*[-ZERO] Need check /*0x3FE*/  StoreOpcode( MSG_GUILD_EVENT_LOG_QUERY,         "MSG_GUILD_EVENT_LOG_QUERY",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
