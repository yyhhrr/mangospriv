...
enum SpellAttributesEx
{
    ...
    SPELL_ATTR_EX_NO_INITIAL_AGGRO				= 0x00200000,            // 21
...
{
    SPELL_ATTR_EX4_BINARY                       = 0x00000001,            // 0 (custom, unused in dbc) rolls binary resistance only
...
enum SpellDmgClass
{
    ...
    SPELL_DAMAGE_CLASS_SPECIAL  = 4                         // custom value (no bonuses, can only crit)
};
...
enum ChatMsg
{
    ...
    CHAT_MSG_RAID_BOSS_WHISPER      = 26,
    CHAT_MSG_RAID_BOSS_EMOTE        = 90,
