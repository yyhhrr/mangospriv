...
enum MangosStrings
{
	...
	LANG_BG_WS_START_TWO_MINUTES		= 616,
	...
	LANG_BG_AB_START_TWO_MINUTES		= 667,
...
//                                      = 758, not used
    ...
    //                                    10000-10999
    // opvp ep
    LANG_OPVP_EP_CAPTURE_NORTHPASS_H    = 10003,
    LANG_OPVP_EP_CAPTURE_NORTHPASS_A    = 10004,
    LANG_OPVP_EP_CAPTURE_EASTWALL_H     = 10005,
    LANG_OPVP_EP_CAPTURE_EASTWALL_A     = 10006,
    LANG_OPVP_EP_CAPTURE_CROWNGUARD_H   = 10007,
    LANG_OPVP_EP_CAPTURE_CROWNGUARD_A   = 10008,
    LANG_OPVP_EP_CAPTURE_PLAGUEWOOD_H   = 10009,
    LANG_OPVP_EP_CAPTURE_PLAGUEWOOD_A   = 10010,
    LANG_OPVP_EP_LOOSE_NORTHPASS_H      = 10011,
    LANG_OPVP_EP_LOOSE_NORTHPASS_A      = 10012,
    LANG_OPVP_EP_LOOSE_EASTWALL_H       = 10013,
    LANG_OPVP_EP_LOOSE_EASTWALL_A       = 10014,
    LANG_OPVP_EP_LOOSE_CROWNGUARD_H     = 10015,
    LANG_OPVP_EP_LOOSE_CROWNGUARD_A     = 10016,
    LANG_OPVP_EP_LOOSE_PLAGUEWOOD_H     = 10017,
    LANG_OPVP_EP_LOOSE_PLAGUEWOOD_A     = 10018,
    // opvp si
