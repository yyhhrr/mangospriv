...
class MANGOS_DLL_DECL ObjectAccessor : public MaNGOS::Singleton<ObjectAccessor, MaNGOS::ClassLevelLockable<ObjectAccessor, ACE_Thread_Mutex> >
{
    ...
    public:
        ...
        // Player access
        static MANGOS_DLL_SPEC Player* FindPlayer(ObjectGuid guid, bool inWorld = true); // if need player at specific map better use Map::GetPlayer
    ...
    private:
        ...
        std::deque<Player*> i_deletablePlayer;
};
