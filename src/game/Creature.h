...
enum CreatureFlagsExtra
{
	...
	CREATURE_FLAG_EXTRA_NO_PATHFINDING  = 0x00001000,       // creature Pathfinding deaktiviert
	CREATURE_FLAG_EXTRA_FLAG_NO_CALL_ASSIST = 0x2000,
};
...
enum SelectFlags
{
    ...
    SELECT_FLAG_IN_MELEE_RANGE = 0x020,
    SELECT_FLAG_NOT_IN_MELEE_RANGE = 0x040,
	SELECT_FLAG_NOT_TANK = 0x080,
};
...
class MANGOS_DLL_SPEC Creature : public Unit
{
    ...
    public:
		...
		uint32 getRank() const { return GetCreatureInfo()->rank; }
        ...
        const CreatureAI* AI() const { return i_AI; }
        ...
        void SetBaseResistance(UnitMods type, int32 baseValue);
		...
		{
			mLastAttackPosition.x = m_combatStartX = x;
			mLastAttackPosition.y = m_combatStartY = y;
			mLastAttackPosition.z = m_combatStartZ = z;
		}
        ...
        bool GetCombatReachTimerExpired();
        void ResetCombatReachTimer();
        ...
        bool m_baseResistance[6];                           // don't send to client
        float m_aggroRadius;
    protected:
    ...
    private:
        uint32 m_combatReachableTimer;
        bool m_decreaseCombatReachTimer;
