...
class BattleGround
{
    ...
    public:
        ...
        void ScheduleRevive(uint64 guid);
		...
		void SpellAuraRemove(Player *plr, uint32 diff);
    ...
    protected:
        ...
        std::map<uint64, uint32>  m_DelayedRevive;
    ...
    private:
		...
		//Dotox
        bool   m_SpellAuraCountDown;
        uint32 m_SpellAuraCountDownTimer;
        char const *m_Name;
