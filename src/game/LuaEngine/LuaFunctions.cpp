...
ElunaRegister<Unit> UnitMethods[] =
{
	...
	{ "GetBoundingRadius", &LuaUnit::GetBoundingRadius },                 // :GetBoundingRadius() - Returns the units bounding radius (the red circle on the ground)
#if (!defined(TBC) && !defined(CLASSIC))
...
{
    // Getters 
	{ "GetInstance", &LuaCreature::GetInstanceData },                                 // :GetInstanceData() - Gets a Pointer to an InstanceData object
...
ElunaRegister<GameObject> GameObjectMethods[] =
{
	...
	{ "DespawnAndDelete", &LuaGameObject::DespawnAndDelete }, // :DespawnAndDelete() - Sends the despawn animation to players and then deletes (despawns) the object
...
ElunaRegister<Map> MapMethods[] =
{
	...
	{ "GetGroundHeight", &LuaMap::GetGroundHeight },          // :GetGroundHeight(x, y, z) - Returns the terrains height at the given coordinates
...
ElunaRegister<InstanceData> InstanceMethods[] =
{
	// Getters
	{ "GetData64", &LuaInstance::GetData64 },                                  // :GetData64(data) - Returns the 64 bit value for the given data
	{ "GetData", &LuaInstance::GetData },                                      // :GetData(data) - Returns the 32 bit value for the given data

	// Setters
	{ "SetData64", &LuaInstance::SetData64 },                                  // :SetData64(data, value) - Sets the 64 bit value for the given data
	{ "SetData", &LuaInstance::SetData },                                      // :SetData(data, value) - Sets the 32 bit value for the given data
...
void RegisterFunctions(lua_State* L)
{
	...
	ElunaTemplate<InstanceData>::Register(L, "InstanceData");
	ElunaTemplate<InstanceData>::SetMethods(L, InstanceMethods);
}
