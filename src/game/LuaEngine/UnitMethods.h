...
namespace LuaUnit
{
    ...
    int GetCurrentSpell(lua_State* L, Unit* unit)
    {
        ...
        Eluna::Push(L, unit->GetCurrentSpell(static_cast<CurrentSpellTypes>(type)).get());
        return 1;
    }
	...
	int GetBoundingRadius(lua_State* L, Unit* unit)
	{
		Eluna::Push(L, unit->GetObjectBoundingRadius());
		return 1;
	}
