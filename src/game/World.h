...
enum eConfigUInt32Values
{
	...
	CONFIG_UINT32_SKILL_GAIN_CRAFTING_PREMIUM,
    CONFIG_UINT32_SKILL_GAIN_DEFENSE,
    CONFIG_UINT32_SKILL_GAIN_GATHERING,
	CONFIG_UINT32_SKILL_GAIN_GATHERING_PREMIUM,
	...
	CONFIG_UINT32_INSTANT_FLIGHT_PREMIUM,
    CONFIG_UINT32_PACKET_SPOOF_POLICY,
    CONFIG_UINT32_PACKET_SPOOF_BANMODE,
    CONFIG_UINT32_PACKET_SPOOF_BANDURATION,
...
class World
{
    public:
        ...
        const std::unordered_map<uint32, WorldSession*>& GetAllSessions() const { return m_sessions; }
		...
		**/
        ...
        void SendWorldState(WorldSession *plr);
        void UpdateWorldState();
        uint32 GetWorldState(uint32 id) { return m_WorldState[id]; }
    ...
    private:
		...
		uint32 m_PremiumAccountCheckTimer;
