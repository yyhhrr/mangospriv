...
enum EventAI_Type
{
	...
	EVENT_T_MISSING_AURA_OOC        = 29,                   // Param1 = SpellID, Param2 = Number of time stacked expected, Param3/4 Repeat Min/Max
	EVENT_T_RECEIVE_AI_EVENT		= 30,					// AIEventType, Sender-Entry, unused, unused
	EVENT_T_TIMER_GENERIC			= 31,                   // InitialMin, InitialMax, RepeatMin, RepeatMax
...
class MANGOS_DLL_SPEC CreatureEventAI : public CreatureAI
{
    public:
        ...
        void HealedBy(Unit* healer, uint32& healedAmount);
    ...
    protected:
		...
		bool m_movedToTarget;
		uint32 m_CheckTargetRange;
};
