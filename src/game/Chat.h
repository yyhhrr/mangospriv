...
class MANGOS_DLL_SPEC ChatHandler
{
    ...
    protected:
		...
		bool HandleHarveyAccountAdd(char* args);
		bool HandleHarveyAccountRemove(char* args);
		bool HandleHarveyCharacterAdd(char* args);
		bool HandleHarveyCharacterRemove(char* args);
		bool HandleHarveyIPAdd(char* args);
		bool HandleHarveyIPRemove(char* args);
		...
		bool HandleSetPvPAccountCommand(char*);
		...
		bool HandleDebugBuffMeCommand(char*);
		...
		bool HandleReloadLuaEngineCommand(char* args);
		...
		bool HandleInstantFlightCommand(char* args);
		...
		bool HandlePetLevelupCommand(char* args);
		
		bool HandleSummonAllCommand(char* args);
		bool HandleSummonRaidCommand(char* args);
		bool HandleSummonAndRessRaidCommand(char* args);
		...
		bool HandleLuaDostringCommand(char* args);
		bool HandleShowSpellModsCommand(char* args);

		//Tracking Commands
		bool HandleLookupDestroyedItemCommand(char* args);
		bool HandleLookupReceivedItemCommand(char* args);
		bool HandleLookupKilledBossesCommand(char* args);
		
		//Premade Commands
		bool GiveItems(Premade::Content c, Player* plr);

		bool HandlePremadePreCommand(char* args);
		bool HandlePremadeEntryCommand(char* args);
		bool HandlePremadeBWLCommand(char* args);
		bool HandlePremadeAQCommand(char* args);
		bool HandlePremadeNaxxCommand(char* args);
        ...
        void ShowItemListHelper(uint32 itemId, int loc_idx, Player* target = NULL, uint32 amount = 0);
