...
struct MANGOS_DLL_SPEC LootStoreItem
{
...
class LootTemplate
{
    ...
    public:
        ...
        void Process(Loot& loot, LootStore const& store, bool rate, Player* owner, uint8 GroupId = 0) const;
...
struct MANGOS_DLL_SPEC Loot
{
	...
	bool hasLootItem(uint32 itemId);
	void removeLootItem(uint32 itemId);
